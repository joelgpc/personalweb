...
const ContactStepEmail: React.FC<ContactStepEmailProps> = ({
    value,
    onChange,
    onKeyDown,
    fieldError
            ...
            >
                ...
                `}>
                    <input
                        ...
                        placeholder={t('steps.2.placeholder')}
                        className={`
                            w-full
                    ...
                    {/* Ícono de validación */}
                    {value && !fieldError && value.includes('@') && (
                        <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                    ...
                    {fieldError && (
                        ...
                        >
                            <p className="text-sm text-red-500 dark:text-red-400 text-center">
                                {t(fieldError.includes('@') ? 'validation.email' : 'validation.required')}
                            </p>
                        </motion.div>
                    )}
                </AnimatePresence>
